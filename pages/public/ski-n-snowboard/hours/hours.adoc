...
2 hour ${{site.data.MK-Variables.mk-tubing.mk-tubing-2hr:}}.footnote:price[_Prices Quoted for the {{site.data.MK-Variables.mk-season:}} Season._] Regular Snow Tubing Sessions

2 Hour ${{site.data.MK-Variables.mk-tubing.mk-tubing-2hr-glow:}}.footnote:price[] Glow Tubing Session	
