...
2 hr *${{site.data.MK-Variables.mk-tubing.mk-tubing-2hr:}}*footnote[_Prices Quoted for the {{site.data.MK-Variables.mk-season:}} Season._] Regular Snow Tubing Sessions	2 hr *${{site.data.MK-Variables.mk-tubing.mk-tubing-2hr-glow:}}* Glow Tubing Session
